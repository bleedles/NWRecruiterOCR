...
module.exports = {
  ...
  box: {
    ...
    appAuth: {
      ...
      privateKeyPath: './config/keys/dev_private_key.pem',
      passphrase: 'cb01c6d7d7a4673c2336de14948bedb2',
      accessToken: process.env.ACCESS_TOKEN || 'VBZyWhQE3ig2H34FsbwQ3A5wU25AXnUf'
    },
    folderid: '32442834639',
    scope: 'enterprise_16885475',
    templatekey: 'nwrecruitupdate',
    appUserID: '2145636820',
  ...
  nationwideBoxAppSettings: {
    ...
    appAuth: {
      ...
      privateKeyPath: './config/keys/nw_private_key.pem',
      passphrase: "f5e993e68f75acef237554192fb46e46"
    },
    folderid: '33529102499',
    scope: 'enterprise_59407',
    templatekey: 'nwrecruitupdate',
    appUserID: '2239656801',
    enterpriseID: "59407"
  },
  azure: {
